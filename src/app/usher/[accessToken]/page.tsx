    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .up-action-icon  { font-size: 1.25rem; flex-shrink: 0; }
      ...
      <div className="up-wrap">
        ...
        <div className="up-stats">
          <div className="up-stat">
            <div className="up-stat-num">{stats.checkedIn}</div>
            <div className="up-stat-label">Checked in</div>
          </div>
          <div className="up-stat">
            <div className="up-stat-num">{stats.pending}</div>
            <div className="up-stat-label">Pending</div>
          </div>
          <div className="up-stat">
            <div className="up-stat-num">{stats.totalGuests}</div>
        ...
        <div className="up-progress-wrap">
          ...
          <div className="up-progress-track">
            <div className="up-progress-fill" style={{ width: `${checkinPct}%` }} />
          </div>
        </div>
          ...
          {usher.role === "MAIN" ? (
            ...
            <>
              ...
              <Link href={`/checkin/${accessToken}/search`} className="up-action">
                <span className="up-action-icon">🔍</span>
                <div>
                  <div className="up-action-label">Search Guest</div>
                  <div className="up-action-desc">Find guest by name or phone number</div>
                </div>
                <span className="up-action-arrow">→</span>
              </Link>
            </>
            ...
            <>
              ...
              <Link href={`/checkin/${accessToken}/search`} className="up-action">
                <span className="up-action-icon">🔍</span>
                <div>
                  <div className="up-action-label">Find a Guest</div>
                  <div className="up-action-desc">Look up a guest's table by name or phone</div>
                </div>
                <span className="up-action-arrow">→</span>
              </Link>
            </>
