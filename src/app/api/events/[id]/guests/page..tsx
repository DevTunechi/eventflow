  ...
  return (
    <>
      ...
      <div className="gp">
        ...
        {/* Add success banner */}
        {addSuccess && (
          <div className="gp-banner gp-banner-ok">✓ Guest added successfully</div>
        )}

        {/* Import success banner */}
        {importSuccess > 0 && (
          <div className="gp-banner gp-banner-ok">✓ {importSuccess} guest{importSuccess > 1 ? "s" : ""} imported successfully</div>
        )}
                  ...
                  <>
                    ...
                    <div className="gp-form-actions" style={{ marginTop: "1rem" }}>
                      <button className="gp-btn gp-btn-gold" onClick={handleCsvImport} disabled={importing}>
                        {importing ? "Importing…" : `Import ${csvPreview.length} Guests`}
                      </button>
