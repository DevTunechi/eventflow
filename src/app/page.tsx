...
import Image from "next/image" // Next.js Image — optimises from public/ automatically
    ...
    <>
      ...
      <div className="login-root">
        ...
        <div className="left-panel">
          ...
          {/* Top-left logo lockup — matches right panel */}
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
            <Image
              src="/eflogo.png"
              alt="EventFlow"
              width={28}        // slightly smaller than right panel (36px)
              height={28}
              priority
              style={{ objectFit: "contain" }}
            />
            {/* Bebas Neue matches the geometric boldness
                of the EF mark — angular, strong, condensed */}
            <span style={{
        ...
        <div className="right-panel">
          <div className="login-card">
            ...
            {/* Logo: loaded from public/eflogo.png via
                Next.js Image — auto-optimised, lazy loaded */}
